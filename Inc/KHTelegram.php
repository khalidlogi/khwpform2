...
// You can set your API data here if you haven't done it in the constructor.
// $telegram->setToken('YOUR_BOT_TOKEN');
// $telegram->setUser('YOUR_CHAT_ID');
// $telegram->setMessage('Your custom message');
//$result = $telegram->sendNotification();
?>